...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function () {
        ...
        // 这里是简单的调用，其余api请参考文档
        __WEBPACK_IMPORTED_MODULE_1_weui_js___default.a.uploader('#uploaderEventLog', {
            url: IMAGE_SERVER_URL,
            auto: false,
            onQueued: function () {
                that.$data.uploadEventLogList.push(this);
            }
        });

        __WEBPACK_IMPORTED_MODULE_1_weui_js___default.a.uploader('#uploaderOrganizerLog', {
            url: IMAGE_SERVER_URL,
            auto: false,
            onQueued: function () {
                that.$data.uploadEventLogList.push(this);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._m(17)])])])])])], 1)]), _vm._v(" "), _vm._m(18), _vm._v(" "), _c('div', {
...
//# sourceMappingURL=app.7913196bd70408bb3254.js.map